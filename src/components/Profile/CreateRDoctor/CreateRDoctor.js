...
const CreateRDoctor = () => {
    ...
    const handleRegisterDoctor = (values) => {
        let data = {
            ...values,
        ...
        AccountService.registerDoctor(data).then((response) => {
