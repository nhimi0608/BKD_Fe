                ...
                >
                    ...
                    <Modal.Body>
                        <div className="row">
                            ...
                            <div className="row">
                                <h2 className="text-md-center">Lịch sử khám</h2>
                                <Table hover>
                                    <thead>
                                                ...
                                                <tr key={index} align="center">
                                                    ...
                                                    <td>
                                                        <Link to={`/house-detail/${h.id}`} className="nav-link">
                                                            <h5 style={{color:'blue'}}>{h.doctor?.name}</h5>
                                                        </Link>
                                                    </td>
                                                    <td>{h.doctor?.province}</td>
                                                    <td>{h.status}</td>
                                                    <td>{formatCurrency(h.doctor?.sale)}</td>
                                                    <td style={{color:'red'}}> {h.result}</td>
                                                </tr>
                                            )
                                        }) :
                                        <tr align="center">
