...
import {getHouseByIdAndOwnerId} from "../../service/doctorService";
            ...
            {!_.isEmpty(house) &&
                <Formik
                    ...
                    {({values}) => (
                        <Form>
                            <div className="row">
                                <h2 className="text-center text-uppercase mb-5">{houseId ? "Sửa đổi thông tin bác sĩ" : "Thêm bác sĩ mới"}</h2>
                                <div className="mb-3 col-4">
                                    <label htmlFor="name" className="form-label">Tên bác sĩ</label>
                                    <Field type="text" className="form-control" id="name" placeholder="Nhập tên bác sĩ"
                                           name="name"/>
