...
const AccountService = {
    ...
    registerDoctor: async (data) => {
        return new Promise((resolve, reject) => {
            instance.post("/api/owners/create-house", data).then((response) => {
                resolve(response.data);
            }).catch(function (err) {
                alert(err);
                console.log(err);
    ...
    findAllDoctors: async (currentPage) => {
        return await instance.get(`/api/doctor/find-all?page=${currentPage}`);
    },
    blockAccount: (accId) => {
