...
import CreateRDoctor from "./components/Profile/CreateRDoctor/CreateRDoctor";
import ListDoctor from './components/Profile/Account/ListDoctor';
import RegisterDoctor from './components/Profile/RegisterDoctor/RegisterDoctor';
        ...
        <div className="App">
            ...
            <Routes>
                ...
                <Route path={"/profile/"} element={<Profile/>}>
                    ...
                    <Route path={"create-owner"} element={<CreateDoctor />}/>
                    <Route path={"create-doctor"} element={<CreateRDoctor />}/>
